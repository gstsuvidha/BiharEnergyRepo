 ...
 gstr1AccountingUnitExtraInfoList:string;
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      ...
      this.gstr1ReportingService.getGstr1FinalReport(this.monthId,this.yearId,this.company)
...
// this.gstr1ReportingService.getAccountingUnitExtraInfo()
//       .subscribe(gstr1AccountingUnitExtraInfo => {
//           this.gstr1AccountingUnitExtraInfoList = gstr1AccountingUnitExtraInfo;
